...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 172.18.102.24/24 | 172.18.102.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_L3_LEAF2 | Vlan4094 | 10.255.1.69 | Port-Channel511 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet20 | ce2_Ethernet1 | *trunk | *10,11,12,21,22,102,122 | *- | *- | 20 |
| Ethernet51/1 | MLAG_PEER_MCI-CTFSTL-LF02b_Ethernet51/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 511 |
| Ethernet52/1 | MLAG_PEER_MCI-CTFSTL-LF02b_Ethernet52/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 511 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_LINK_TO_MCI-CTFSTL-SP01_Ethernet51/1 | routed | - | 10.255.255.9/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_LINK_TO_MCI-CTFSTL-SP02_Ethernet51/1 | routed | - | 10.255.255.11/31 | default | 1500 | False | - | - |
...
| Port-Channel511 | MLAG_PEER_MCI-CTFSTL-LF02b_Po511 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| Loopback12 | VRFA_VTEP_DIAGNOSTICS | VRFA | 10.255.11.5/32 |
...
| 10.255.1.101 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRFA | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.10.102.101 | 65122 | VRFA | - | - | - | - | - | - | - | - |
...
router bgp 65102
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description MCI-CTFSTL-LF02b
   ...
   vrf VRFA
      ...
      router-id 10.255.0.5
      neighbor 10.10.102.101 remote-as 65122
      neighbor 10.10.102.101 description CE2_VLAN102
      neighbor 10.255.1.101 peer group MLAG-IPv4-UNDERLAY-PEER
      redistribute connected
      !
      address-family ipv4
         neighbor 10.10.102.101 activate
```
...
ip address virtual source-nat vrf VRFA address 10.255.11.5
```

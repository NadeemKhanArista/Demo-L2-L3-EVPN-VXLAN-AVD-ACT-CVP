...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 172.18.102.22/24 | 172.18.102.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_L3_LEAF1 | Vlan4094 | 10.255.1.65 | Port-Channel511 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet20 | ce1_Ethernet1 | *trunk | *10,11,12,21,22,101,111 | *- | *- | 20 |
| Ethernet51/1 | MLAG_PEER_MCI-CTFSTL-LF01b_Ethernet51/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 511 |
| Ethernet52/1 | MLAG_PEER_MCI-CTFSTL-LF01b_Ethernet52/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 511 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_LINK_TO_MCI-CTFSTL-SP01_Ethernet49/1 | routed | - | 10.255.255.1/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_LINK_TO_MCI-CTFSTL-SP02_Ethernet49/1 | routed | - | 10.255.255.3/31 | default | 1500 | False | - | - |
...
interface Ethernet49/1
   description P2P_LINK_TO_MCI-CTFSTL-SP01_Ethernet49/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet50/1
   description P2P_LINK_TO_MCI-CTFSTL-SP02_Ethernet49/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet51/1
   description MLAG_PEER_MCI-CTFSTL-LF01b_Ethernet51/1
   no shutdown
   channel-group 511 mode active
!
interface Ethernet52/1
   description MLAG_PEER_MCI-CTFSTL-LF01b_Ethernet52/1
   no shutdown
   channel-group 511 mode active
```
...
| Port-Channel511 | MLAG_PEER_MCI-CTFSTL-LF01b_Po511 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel511
   description MLAG_PEER_MCI-CTFSTL-LF01b_Po511
   no shutdown
   switchport
   switchport mode trunk
...
| Loopback12 | VRFA_VTEP_DIAGNOSTICS | VRFA | 10.255.11.3/32 |
...
| Vlan101 | Nadeem_VLAN | VRFA | - | False |
...
!
interface Vlan101
   description Nadeem_VLAN
   no shutdown
   vrf VRFA
   ip address 10.10.101.102/24
!
interface Vlan3009
...
!
interface Vxlan1
   description MCI-CTFSTL-LF01a_VTEP
...
| 10.255.1.97 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRFA | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.10.101.101 | 65111 | VRFA | - | - | - | - | - | - | - | - |
...
router bgp 65101
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description MCI-CTFSTL-LF01b
   ...
   vrf VRFA
      ...
      router-id 10.255.0.3
      neighbor 10.10.101.101 remote-as 65111
      neighbor 10.10.101.101 description CE1_VLAN101
      neighbor 10.255.1.97 peer group MLAG-IPv4-UNDERLAY-PEER
      redistribute connected
      !
      address-family ipv4
         neighbor 10.10.101.101 activate
```
...
ip address virtual source-nat vrf VRFA address 10.255.11.3
```

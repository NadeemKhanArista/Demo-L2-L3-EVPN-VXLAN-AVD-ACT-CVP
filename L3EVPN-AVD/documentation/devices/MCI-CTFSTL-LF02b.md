...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 172.18.102.25/24 | 172.18.102.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_L3_LEAF2 | Vlan4094 | 10.255.1.68 | Port-Channel511 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet20 | ce2_Ethernet2 | *trunk | *10,11,12,21,22,102,122 | *- | *- | 20 |
| Ethernet51/1 | MLAG_PEER_MCI-CTFSTL-LF02a_Ethernet51/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 511 |
| Ethernet52/1 | MLAG_PEER_MCI-CTFSTL-LF02a_Ethernet52/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 511 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_LINK_TO_MCI-CTFSTL-SP01_Ethernet52/1 | routed | - | 10.255.255.13/31 | default | 1500 | False | - | - |
| Ethernet50/1 | P2P_LINK_TO_MCI-CTFSTL-SP02_Ethernet52/1 | routed | - | 10.255.255.15/31 | default | 1500 | False | - | - |
...
interface Ethernet20
   description ce2_Ethernet2
   no shutdown
   channel-group 20 mode active
!
interface Ethernet49/1
   description P2P_LINK_TO_MCI-CTFSTL-SP01_Ethernet52/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet50/1
   description P2P_LINK_TO_MCI-CTFSTL-SP02_Ethernet52/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet51/1
   description MLAG_PEER_MCI-CTFSTL-LF02a_Ethernet51/1
   no shutdown
   channel-group 511 mode active
!
interface Ethernet52/1
   description MLAG_PEER_MCI-CTFSTL-LF02a_Ethernet52/1
   no shutdown
   channel-group 511 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel20 | ce2 | switched | trunk | 10,11,12,21,22,102,122 | - | - | - | - | 20 | - |
| Port-Channel511 | MLAG_PEER_MCI-CTFSTL-LF02a_Po511 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel20
   ...
   no shutdown
   switchport
   switchport trunk allowed vlan 10,11,12,21,22,102,122
   switchport mode trunk
   mlag 20
!
interface Port-Channel511
   description MLAG_PEER_MCI-CTFSTL-LF02a_Po511
   no shutdown
   switchport
   switchport mode trunk
...
| Loopback12 | VRFA_VTEP_DIAGNOSTICS | VRFA | 10.255.11.6/32 |
...
!
interface Vlan122
   description Shmo_VLAN
   no shutdown
   vrf VRFA
   ip address 10.10.122.102/24
!
interface Vlan3009
...
!
interface Vxlan1
   description MCI-CTFSTL-LF02b_VTEP
...
| 10.255.1.100 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRFA | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
| 10.10.122.101 | 65122 | VRFA | - | - | - | - | - | - | - | - |
...
| 122 | 10.255.0.6:10122 | 10122:10122 | - | - | learned |
...
router bgp 65102
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description MCI-CTFSTL-LF02a
   ...
   vrf VRFA
      ...
      router-id 10.255.0.6
      neighbor 10.10.122.101 remote-as 65122
      neighbor 10.10.122.101 description CE2_VLAN122
      neighbor 10.255.1.100 peer group MLAG-IPv4-UNDERLAY-PEER
      redistribute connected
      !
      address-family ipv4
         neighbor 10.10.122.101 activate
```
...
ip address virtual source-nat vrf VRFA address 10.255.11.6
```
